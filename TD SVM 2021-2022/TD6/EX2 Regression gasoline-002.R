...
#1. Diviser les données en 2 parties: 2/3 Test et 1/3 Appr (en echantillonan au hazard).

#2. Construire une prediction  à partir de la partie Appr et clculer l'erreur quadratique      
...
#   fenetre h=1/sigma du noyau Gaussien (RBF) pour C, eps fixés (eps=0.03).
#   Optimiser le paramètre h. 
...
#   fenetre h=1/sigma du noyau Gaussien (RBF) pour nu fixé.
#   Optimiser le paramètre h. 
...
#7. Choisir les paramètres par cross validation. 
#   Tracer 3 erreurs (d'apprentissage, de cross validation, et de verification) en fonction de 
#   la largeur de la fenetre h du noyau Gaussien (RBF) pour  C,eps fixé.

#8. Choisir les paramètres par cross validation. 
#   Tracer 3 erreurs (d'apprentissage, de cross validation, et de verification) en fonction de 
#   C (h = choix par default, eps fixé) pour le noyau Gaussien (RBF).


#9. Choisir les paramètres par cross validation. 
#   Tracer 3 erreurs (d'apprentissage, de cross validation, et de verification) en fonction de 
